...
def test_model(model, x_test, y_test):
  ...
  return auc
# Load dataset
right_client_data = clients["right"]

# Accessing the training splits
x_train = right_client_data["train"]["x"]
y_train = right_client_data["train"]["y"]
...
print(f"Node 2 Model AUC: {auc_score}")
...
node_id = 2  # Unique identifier for this node
tx_hash = contract.functions.storeNodeWeights(node_id, weights_hash).transact({
    'from': web3.eth.accounts[2]  # Use the appropriate account
})
