...
def test_model(model, x_test, y_test):
  ...
  return auc
# Load dataset
bottom_client_data = clients["bottom"]

# Accessing the training splits
x_train = bottom_client_data["train"]["x"]
y_train = bottom_client_data["train"]["y"]
...
print(f"Node 3 Model AUC: {auc_score}")
...
node_id = 3  # Unique identifier for this node
tx_hash = contract.functions.storeNodeWeights(node_id, weights_hash).transact({
    'from': web3.eth.accounts[3]  # Use the appropriate account
})
